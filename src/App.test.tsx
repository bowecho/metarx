...
describe('App', () => {
  ...
  it('shows a decoded METAR after a successful lookup', async () => {
    ...
    await userEvent.click(screen.getByRole('button', { name: /analyze metar/i }))
  ...
  it('cycles theme mode when the theme button is pressed', async () => {
    ...
    expect(themeButton).toHaveTextContent('Theme: dark (auto)')
    ...
    expect(screen.getByRole('button', { name: /theme mode:/i })).toHaveTextContent('Theme: light')
  })
})
